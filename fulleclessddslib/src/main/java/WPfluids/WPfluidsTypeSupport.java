...
public class WPfluidsTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "WPfluids";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final WPfluidsTypeSupport _singleton
    = new WPfluidsTypeSupport();
    ...
    */
    public static WPfluidsTypeSupport get_instance() {
        return _singleton;
    }

    public static WPfluidsTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return WPfluidsTypeCode.VALUE;
    }

    public Object create_data() {
        return WPfluids.create();
    }
    ...
    * <code>this</code> is not a <code>WPfluids</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        WPfluids typedDst = (WPfluids) destination;
        WPfluids typedSrc = (WPfluids) source;
        ...
        Object sample) 
    {
        ...
        WPfluids typedSrc = (WPfluids) sample;
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            dst.writeDouble(typedSrc.WDPa);

            dst.writeDouble(typedSrc.WDkelvins);

            dst.writeDouble(typedSrc.WWPa);

            dst.writeDouble(typedSrc.WPAvapor);
        }
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            WPfluids typedDst = (WPfluids) dst;
            typedDst.clear();      
            try{
                typedDst.id = src.readInt();
                typedDst.WDPa = src.readDouble();
                typedDst.WDkelvins = src.readDouble();
                typedDst.WWPa = src.readDouble();
                typedDst.WPAvapor = src.readDouble();
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            WPfluids typedDst = (WPfluids) sample;
    ...
    */
    ...
    int mask) {
        return new WPfluidsDataWriter(native_writer, listener, mask, this);
    }
    ...
    int mask) {
        ...
        return new WPfluidsDataReader(native_reader, listener, mask, this);   
    ...
    protected WPfluidsTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME,true,WPfluidsTypeCode.VALUE, WPfluids.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected WPfluidsTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,WPfluidsTypeCode.VALUE, WPfluids.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
