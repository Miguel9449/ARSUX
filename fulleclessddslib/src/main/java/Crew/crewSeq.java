...
/**
* A sequence of crew instances.
*/
public final class crewSeq extends LoanableSequence implements Copyable {
    // -----------------------------------------------------------------------
    // Package Fields
    // -----------------------------------------------------------------------
    ...
    */
    ...
    public crewSeq (int initialMaximum) {
        super(crew.class, initialMaximum);
    }

    public crewSeq (Collection elements) {
        super(crew.class, elements);
    }

    public crew get(int index) {
        return (crew) super.get(index);
    }
    ...
    */
    public Object copy_from(Object src) {
        ...
        // copy 'new' crew objects (beyond the original size of this object)
