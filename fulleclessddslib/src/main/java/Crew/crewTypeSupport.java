...
public class crewTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "crew";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final crewTypeSupport _singleton
    = new crewTypeSupport();
    ...
    */
    public static crewTypeSupport get_instance() {
        return _singleton;
    }

    public static crewTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return crewTypeCode.VALUE;
    }
    ...
    * <code>this</code> is not a <code>crew</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        crew typedDst = (crew) destination;
        crew typedSrc = (crew) source;
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            dst.writeDouble(typedSrc.crew1);

            dst.writeDouble(typedSrc.crew2);

            dst.writeDouble(typedSrc.crew3);

            dst.writeDouble(typedSrc.crew4);

            dst.writeDouble(typedSrc.timeofday);
        }
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            crew typedDst = (crew) dst;
            typedDst.clear();      
            try{
                typedDst.id = src.readInt();
                typedDst.state = src.readInt();
                typedDst.crew1 = src.readDouble();
                typedDst.crew2 = src.readDouble();
                typedDst.crew3 = src.readDouble();
                typedDst.crew4 = src.readDouble();
                typedDst.timeofday = src.readDouble();
    ...
    */
    ...
    int mask) {
        return new crewDataWriter(native_writer, listener, mask, this);
    }
    ...
    int mask) {
        ...
        return new crewDataReader(native_reader, listener, mask, this);   
    ...
    protected crewTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME,true, crewTypeCode.VALUE, crew.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected crewTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport, crewTypeCode.VALUE, crew.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
