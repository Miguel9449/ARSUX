...
public class FAfluidsTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "FAfluids";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final FAfluidsTypeSupport _singleton
    = new FAfluidsTypeSupport();
    ...
    */
    public static FAfluidsTypeSupport get_instance() {
        return _singleton;
    }

    public static FAfluidsTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return FAfluidsTypeCode.VALUE;
    }

    public Object create_data() {
        return FAfluids.create();
    }
    ...
    * <code>this</code> is not a <code>FAfluids</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        FAfluids typedDst = (FAfluids) destination;
        FAfluids typedSrc = (FAfluids) source;
        ...
        Object sample) 
    {
        ...
        FAfluids typedSrc = (FAfluids) sample;
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            dst.writeDouble(typedSrc.flowIn);

            dst.writeDouble(typedSrc.flowout);

            dst.writeDouble(typedSrc.temperatureOut);

            for(int i1__ = 0; i1__< 4; ++i1__){

                dst.writeDouble(typedSrc.ARSmolefracs[i1__]);
            }

            dst.writeDouble(typedSrc.condensationKGS);

            dst.writeDouble(typedSrc.CO2kelvins);

            dst.writeDouble(typedSrc.CO2Pa);
        }
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            FAfluids typedDst = (FAfluids) dst;
            typedDst.clear();      
            try{
                typedDst.id = src.readInt();
                typedDst.flowIn = src.readDouble();
                typedDst.flowout = src.readDouble();
                typedDst.temperatureOut = src.readDouble();
                for(int i1__ = 0; i1__< 4; ++i1__){

                    typedDst.ARSmolefracs[i1__] = src.readDouble();
                }

                typedDst.condensationKGS = src.readDouble();
                typedDst.CO2kelvins = src.readDouble();
                typedDst.CO2Pa = src.readDouble();
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            FAfluids typedDst = (FAfluids) sample;
    ...
    */
    ...
    int mask) {
        return new FAfluidsDataWriter(native_writer, listener, mask, this);
    }
    ...
    int mask) {
        ...
        return new FAfluidsDataReader(native_reader, listener, mask, this);   
    ...
    protected FAfluidsTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME,true, FAfluidsTypeCode.VALUE, FAfluids.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected FAfluidsTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport, FAfluidsTypeCode.VALUE, FAfluids.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
