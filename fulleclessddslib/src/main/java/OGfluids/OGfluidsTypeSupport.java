...
public class OGfluidsTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "OGfluids";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final OGfluidsTypeSupport _singleton
    = new OGfluidsTypeSupport();
    ...
    */
    public static OGfluidsTypeSupport get_instance() {
        return _singleton;
    }

    public static OGfluidsTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return OGfluidsTypeCode.VALUE;
    }

    public Object create_data() {
        return OGfluids.create();
    }
    ...
    * <code>this</code> is not a <code>OGfluids</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        OGfluids typedDst = (OGfluids) destination;
        OGfluids typedSrc = (OGfluids) source;
    ...
    public long get_serialized_sample_max_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += CdrPrimitiveType.DOUBLE.getMaxSizeSerialized(currentAlignment) ;
        currentAlignment += CdrPrimitiveType.DOUBLE.getMaxSizeSerialized(currentAlignment) ;
        currentAlignment +=CdrPrimitiveType.DOUBLE.getArrayMaxSizeSerialized(currentAlignment,  (4));
        currentAlignment += CdrPrimitiveType.DOUBLE.getMaxSizeSerialized(currentAlignment) ;
        currentAlignment += CdrPrimitiveType.DOUBLE.getMaxSizeSerialized(currentAlignment) ;
        currentAlignment += CdrPrimitiveType.DOUBLE.getMaxSizeSerialized(currentAlignment) ;
        currentAlignment += CdrPrimitiveType.DOUBLE.getMaxSizeSerialized(currentAlignment) ;
        ...
        Object sample) 
    {
        ...
        OGfluids typedSrc = (OGfluids) sample;
        ...
        currentAlignment  +=  CdrPrimitiveType.DOUBLE.getArrayMaxSizeSerialized(epd.getAlignment(currentAlignment),  (4));
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            dst.writeDouble(typedSrc.WD2OGkgs);

            dst.writeDouble(typedSrc.OG2WWkgs);

            dst.writeDouble(typedSrc.OG2WWkelvins);

            dst.writeDouble(typedSrc.OGO2kgs);

            for(int i1__ = 0; i1__< 4; ++i1__){

                dst.writeDouble(typedSrc.OGO2molpers[i1__]);
            }

            dst.writeDouble(typedSrc.OGO2kelvins);

            dst.writeDouble(typedSrc.FA2SAkgs);

            dst.writeDouble(typedSrc.OG2HabHeatW);

            dst.writeDouble(typedSrc.OGH2kelvins);

            dst.writeDouble(typedSrc.SA2WWkgs);

            dst.writeDouble(typedSrc.SA2WWkelvins);
        }
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            OGfluids typedDst = (OGfluids) dst;
            typedDst.clear();      
            try{
                typedDst.id = src.readInt();
                typedDst.WD2OGkgs = src.readDouble();
                typedDst.OG2WWkgs = src.readDouble();
                typedDst.OG2WWkelvins = src.readDouble();
                typedDst.OGO2kgs = src.readDouble();
                for(int i1__ = 0; i1__< 4; ++i1__){

                    typedDst.OGO2molpers[i1__] = src.readDouble();
                }

                typedDst.OGO2kelvins = src.readDouble();
                typedDst.FA2SAkgs = src.readDouble();
                typedDst.OG2HabHeatW = src.readDouble();
                typedDst.OGH2kelvins = src.readDouble();
                typedDst.SA2WWkgs = src.readDouble();
                typedDst.SA2WWkelvins = src.readDouble();
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            OGfluids typedDst = (OGfluids) sample;
    ...
    */
    ...
    int mask) {
        return new OGfluidsDataWriter (native_writer, listener, mask, this);            
    }
    ...
    int mask) {
        ...
        return new OGfluidsDataReader(native_reader, listener, mask, this);   
    ...
    protected OGfluidsTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME,true, OGfluidsTypeCode.VALUE, OGfluids.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected OGfluidsTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport, OGfluidsTypeCode.VALUE, OGfluids.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
