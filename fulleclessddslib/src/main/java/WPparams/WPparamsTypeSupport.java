...
public class WPparamsTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "WPparams";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final WPparamsTypeSupport _singleton
    = new WPparamsTypeSupport();
    ...
    */
    public static WPparamsTypeSupport get_instance() {
        return _singleton;
    }

    public static WPparamsTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return WPparamsTypeCode.VALUE;
    }

    public Object create_data() {
        return WPparams.create();
    }
    ...
    * <code>this</code> is not a <code>WPparams</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        WPparams typedDst = (WPparams) destination;
        WPparams typedSrc = (WPparams) source;
        ...
        Object sample) 
    {
        ...
        WPparams typedSrc = (WPparams) sample;
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            dst.writeDouble(typedSrc.T_MTCL_K);

            dst.writeDouble(typedSrc.PROCESSkgs);

            dst.writeDouble(typedSrc.DELIVERYkgs);
        }
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            WPparams typedDst = (WPparams) dst;
            typedDst.clear();      
            try{
                typedDst.id = src.readInt();
                typedDst.state = src.readInt();
                typedDst.rank = src.readInt();
                typedDst.T_MTCL_K = src.readDouble();
                typedDst.PROCESSkgs = src.readDouble();
                typedDst.DELIVERYkgs = src.readDouble();
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            WPparams typedDst = (WPparams) sample;
    ...
    */
    ...
    int mask) {
        return new WPparamsDataWriter (native_writer, listener, mask, this);            
    }
    ...
    int mask) {
        ...
        return new WPparamsDataReader(native_reader, listener, mask, this);   
    ...
    protected WPparamsTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME,true, WPparamsTypeCode.VALUE, WPparams.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected WPparamsTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport, WPparamsTypeCode.VALUE, WPparams.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
