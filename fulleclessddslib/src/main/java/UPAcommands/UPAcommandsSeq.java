...
/**
* A sequence of UPAcommands instances.
*/
public final class UPAcommandsSeq extends LoanableSequence implements Copyable {
    // -----------------------------------------------------------------------
    // Package Fields
    // -----------------------------------------------------------------------
    ...
    */
    ...
    public UPAcommandsSeq() {
        super(UPAcommands.class);
    }

    public UPAcommandsSeq (int initialMaximum) {
        super(UPAcommands.class, initialMaximum);
    }

    public UPAcommandsSeq (Collection elements) {
        super(UPAcommands.class, elements);
    }

    public UPAcommands get(int index) {
        return (UPAcommands) super.get(index); 
    }
