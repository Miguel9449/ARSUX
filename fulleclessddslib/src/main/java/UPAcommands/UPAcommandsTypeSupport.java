...
public class UPAcommandsTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "UPAcommands";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final UPAcommandsTypeSupport _singleton
    = new UPAcommandsTypeSupport();
    ...
    */
    public static UPAcommandsTypeSupport get_instance() {
        return _singleton;
    }

    public static UPAcommandsTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return UPAcommandsTypeCode.VALUE;
    }

    public Object create_data() {
        return UPAcommands.create();
    }
    ...
    * <code>this</code> is not a <code>UPAcommands</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        UPAcommands typedDst = (UPAcommands) destination;
        UPAcommands typedSrc = (UPAcommands) source;
        ...
        Object sample) 
    {
        ...
        UPAcommands typedSrc = (UPAcommands) sample;
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            dst.writeDouble(typedSrc.BPA);

            dst.writeBoolean(typedSrc.Replace);

            dst.writeDouble(typedSrc.M1);

            dst.writeDouble(typedSrc.M2);

            dst.writeDouble(typedSrc.M4);

            dst.writeBoolean(typedSrc.DrainARFTA);
        }
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            UPAcommands typedDst = (UPAcommands) dst;
            typedDst.clear();      
            try{
                typedDst.id = src.readInt();
                typedDst.state = src.readInt();
                typedDst.rank = src.readInt();
                typedDst.BPA = src.readDouble();
                typedDst.Replace = src.readBoolean();
                typedDst.M1 = src.readDouble();
                typedDst.M2 = src.readDouble();
                typedDst.M4 = src.readDouble();
                typedDst.DrainARFTA = src.readBoolean();
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            UPAcommands typedDst = (UPAcommands) sample;
    ...
    */
    ...
    Object instance,
    Object key) {
        UPAcommands typedDst
        = (UPAcommands) instance;
        UPAcommands typedSrc
        = (UPAcommands) key;
    ...
    */
    ...
    int mask) {
        return new UPAcommandsDataWriter(native_writer, listener, mask, this);
    }
    ...
    int mask) {
        ...
        return new UPAcommandsDataReader(native_reader, listener, mask, this);   
    ...
    protected UPAcommandsTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME,true,UPAcommandsTypeCode.VALUE, UPAcommands.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected UPAcommandsTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,UPAcommandsTypeCode.VALUE, UPAcommands.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
