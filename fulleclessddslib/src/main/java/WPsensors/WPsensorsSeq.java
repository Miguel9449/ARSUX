...
/**
* A sequence of WPsensors instances.
*/
public final class WPsensorsSeq extends LoanableSequence implements Copyable {
    // -----------------------------------------------------------------------
    // Package Fields
    // -----------------------------------------------------------------------
    ...
    */
    ...
    public WPsensorsSeq() {
        super(WPsensors.class);
    }

    public WPsensorsSeq (int initialMaximum) {
        super(WPsensors.class, initialMaximum);
    }

    public WPsensorsSeq (Collection elements) {
        super(WPsensors.class, elements);
    }

    public WPsensors get(int index) {
        return (WPsensors) super.get(index); 
    }
