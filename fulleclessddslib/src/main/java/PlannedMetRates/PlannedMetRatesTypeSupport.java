...
public class PlannedMetRatesTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "PlannedMetRates";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final PlannedMetRatesTypeSupport _singleton
    = new PlannedMetRatesTypeSupport();
    ...
    */
    public static PlannedMetRatesTypeSupport get_instance() {
        return _singleton;
    }

    public static PlannedMetRatesTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return PlannedMetRatesTypeCode.VALUE;
    }

    public Object create_data() {
        return PlannedMetRates.create();
    }
    ...
    * <code>this</code> is not a <code>PlannedMetRates</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        PlannedMetRates typedDst = (PlannedMetRates) destination;
        PlannedMetRates typedSrc = (PlannedMetRates) source;
    ...
    public long get_serialized_sample_max_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment +=CdrPrimitiveType.DOUBLE.getArrayMaxSizeSerialized(currentAlignment,  (96));
        currentAlignment +=CdrPrimitiveType.DOUBLE.getArrayMaxSizeSerialized(currentAlignment,  (96));
        currentAlignment +=CdrPrimitiveType.DOUBLE.getArrayMaxSizeSerialized(currentAlignment,  (96));
        currentAlignment +=CdrPrimitiveType.DOUBLE.getArrayMaxSizeSerialized(currentAlignment,  (96));
        currentAlignment +=CdrPrimitiveType.DOUBLE.getArrayMaxSizeSerialized(currentAlignment,  (96));
        ...
        Object sample) 
    {
        ...
        PlannedMetRates typedSrc = (PlannedMetRates) sample;
        ...
        currentAlignment  +=  CdrPrimitiveType.DOUBLE.getArrayMaxSizeSerialized(epd.getAlignment(currentAlignment),  (96));
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            for(int i1__ = 0; i1__< 96; ++i1__){
                ...
                dst.writeDouble(typedSrc.CrewTimes[i1__]);
            }

            for(int i1__ = 0; i1__< 96; ++i1__){

                dst.writeDouble(typedSrc.WaterVaporKGS[i1__]);
            }

            for(int i1__ = 0; i1__< 96; ++i1__){

                dst.writeDouble(typedSrc.SensibleWatts[i1__]);
            }

            for(int i1__ = 0; i1__< 96; ++i1__){

                dst.writeDouble(typedSrc.O2KGS[i1__]);
            }

            for(int i1__ = 0; i1__< 96; ++i1__){

                dst.writeDouble(typedSrc.CO2KGS[i1__]);
            }
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            PlannedMetRates typedDst = (PlannedMetRates) dst;
            typedDst.clear();      
            try{
                typedDst.id = src.readInt();
                for(int i1__ = 0; i1__< 96; ++i1__){

                    typedDst.CrewTimes[i1__] = src.readDouble();
                }

                for(int i1__ = 0; i1__< 96; ++i1__){

                    typedDst.WaterVaporKGS[i1__] = src.readDouble();
                }

                for(int i1__ = 0; i1__< 96; ++i1__){

                    typedDst.SensibleWatts[i1__] = src.readDouble();
                }

                for(int i1__ = 0; i1__< 96; ++i1__){

                    typedDst.O2KGS[i1__] = src.readDouble();
                }

                for(int i1__ = 0; i1__< 96; ++i1__){

                    typedDst.CO2KGS[i1__] = src.readDouble();
                }
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            PlannedMetRates typedDst = (PlannedMetRates) sample;
    ...
    */
    ...
    Object instance,
    Object key) {
        PlannedMetRates typedDst
        = (PlannedMetRates) instance;
        PlannedMetRates typedSrc
        = (PlannedMetRates) key;
    ...
    */
    ...
    int mask) {
        return new PlannedMetRatesDataWriter (native_writer, listener, mask, this);            
    }
    ...
    int mask) {
        ...
        return new PlannedMetRatesDataReader(native_reader, listener, mask, this);   
    ...
    protected PlannedMetRatesTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME,true,PlannedMetRatesTypeCode.VALUE,PlannedMetRates.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected PlannedMetRatesTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,PlannedMetRatesTypeCode.VALUE,PlannedMetRates.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
