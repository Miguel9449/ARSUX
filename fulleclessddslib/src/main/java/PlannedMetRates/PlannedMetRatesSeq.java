...
/**
* A sequence of PlannedMetRates instances.
*/
public final class PlannedMetRatesSeq extends LoanableSequence implements Copyable {
    // -----------------------------------------------------------------------
    // Package Fields
    // -----------------------------------------------------------------------
    ...
    */
    ...
    public PlannedMetRatesSeq() {
        super(PlannedMetRates.class);
    }

    public PlannedMetRatesSeq (int initialMaximum) {
        super(PlannedMetRates.class, initialMaximum);
    }

    public PlannedMetRatesSeq (Collection elements) {
        super(PlannedMetRates.class, elements);
    }

    public  PlannedMetRates get(int index) { 
        return (PlannedMetRates) super.get(index); 
    }
