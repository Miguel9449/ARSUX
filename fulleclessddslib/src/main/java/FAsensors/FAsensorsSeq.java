...
/**
* A sequence of FAsensors instances.
*/
public final class FAsensorsSeq extends LoanableSequence implements Copyable {
    // -----------------------------------------------------------------------
    // Package Fields
    // -----------------------------------------------------------------------
    ...
    */
    ...
    public FAsensorsSeq() {
        super(FAsensors.class);
    }

    public FAsensorsSeq (int initialMaximum) {
        super(FAsensors.class, initialMaximum);
    }

    public FAsensorsSeq (Collection elements) {
        super(FAsensors.class, elements);
    }

    public  FAsensors get(int index) { 
        return (FAsensors) super.get(index); 
    }
