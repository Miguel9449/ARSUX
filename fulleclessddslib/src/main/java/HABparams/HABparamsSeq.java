...
/**
* A sequence of HABparams instances.
*/
public final class HABparamsSeq extends LoanableSequence implements Copyable {
    // -----------------------------------------------------------------------
    // Package Fields
    // -----------------------------------------------------------------------
    ...
    */
    ...
    public HABparamsSeq() {
        super(HABparams.class);
    }

    public HABparamsSeq (int initialMaximum) {
        super(HABparams.class, initialMaximum);
    }

    public HABparamsSeq (Collection elements) {
        super(HABparams.class, elements);
    }

    public HABparams get(int index) {
        return (HABparams) super.get(index); 
    }
