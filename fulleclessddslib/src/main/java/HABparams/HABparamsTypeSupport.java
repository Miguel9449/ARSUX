...
public class HABparamsTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "HABparams";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final HABparamsTypeSupport _singleton
    = new HABparamsTypeSupport();
    ...
    */
    public static HABparamsTypeSupport get_instance() {
        return _singleton;
    }

    public static HABparamsTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return HABparamsTypeCode.VALUE;
    }

    public Object create_data() {
        return HABparams.create();
    }
    ...
    * <code>this</code> is not a <code>HABparams</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        HABparams typedDst = (HABparams) destination;
        HABparams typedSrc = (HABparams) source;
    ...
    public long get_serialized_sample_max_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += CdrPrimitiveType.DOUBLE.getMaxSizeSerialized(currentAlignment) ;
        currentAlignment +=CdrPrimitiveType.DOUBLE.getArrayMaxSizeSerialized(currentAlignment,  (12));
        ...
        Object sample) 
    {
        ...
        HABparams typedSrc = (HABparams) sample;
        ...
        currentAlignment  +=  CdrPrimitiveType.DOUBLE.getArrayMaxSizeSerialized(epd.getAlignment(currentAlignment),  (12));

        currentAlignment  +=  CdrPrimitiveType.DOUBLE.getArrayMaxSizeSerialized(epd.getAlignment(currentAlignment),  (2));
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            dst.writeDouble(typedSrc.AirVolume);

            dst.writeDouble(typedSrc.DistrEqLength);

            for(int i1__ = 0; i1__< 12; ++i1__){

                dst.writeDouble(typedSrc.CrewParameters[i1__]);
            }

            for(int i1__ = 0; i1__< 2; ++i1__){

                dst.writeDouble(typedSrc.HabHeatTimes[i1__]);
            }

            for(int i1__ = 0; i1__< 2; ++i1__){

                dst.writeDouble(typedSrc.HabHeat[i1__]);
            }
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            HABparams typedDst = (HABparams) dst;
            typedDst.clear();      
            try{
                typedDst.id = src.readInt();
                typedDst.state = src.readInt();
                typedDst.rank = src.readInt();
                typedDst.AirVolume = src.readDouble();
                typedDst.DistrEqLength = src.readDouble();
                for(int i1__ = 0; i1__< 12; ++i1__){

                    typedDst.CrewParameters[i1__] = src.readDouble();
                }

                for(int i1__ = 0; i1__< 2; ++i1__){

                    typedDst.HabHeatTimes[i1__] = src.readDouble();
                }

                for(int i1__ = 0; i1__< 2; ++i1__){

                    typedDst.HabHeat[i1__] = src.readDouble();
                }
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            HABparams typedDst = (HABparams) sample;
    ...
    */
    ...
    int mask) {
        return new HABparamsDataWriter(native_writer, listener, mask, this);
    }
    ...
    int mask) {
        ...
        return new HABparamsDataReader(native_reader, listener, mask, this);   
    ...
    protected HABparamsTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME,true, HABparamsTypeCode.VALUE, HABparams.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected HABparamsTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport, HABparamsTypeCode.VALUE, HABparams.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
