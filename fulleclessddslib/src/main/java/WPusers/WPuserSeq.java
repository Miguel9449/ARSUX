...
/**
* A sequence of WPuser instances.
*/
public final class WPuserSeq extends LoanableSequence implements Copyable {
    // -----------------------------------------------------------------------
    // Package Fields
    // -----------------------------------------------------------------------
    ...
    */
    ...
    public WPuserSeq (int initialMaximum) {
        super(WPuser.class, initialMaximum);
    }

    public WPuserSeq (Collection elements) {
        super(WPuser.class, elements);
    }

    public  WPuser get(int index) { 
        return (WPuser) super.get(index); 
    }
    ...
    */
    public Object copy_from(Object src) {
        ...
        // copy 'new' WPuser objects (beyond the original size of this object)
