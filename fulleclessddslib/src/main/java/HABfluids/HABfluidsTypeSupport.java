...
public class HABfluidsTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "HABfluids";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final HABfluidsTypeSupport _singleton
    = new HABfluidsTypeSupport();
    ...
    */
    public static HABfluidsTypeSupport get_instance() {
        return _singleton;
    }

    public static HABfluidsTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return HABfluidsTypeCode.VALUE;
    }

    public Object create_data() {
        return HABfluids.create();
    }
    ...
    * <code>this</code> is not a <code>HABfluids</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        HABfluids typedDst = (HABfluids) destination;
        HABfluids typedSrc = (HABfluids) source;
        ...
        Object sample) 
    {
        ...
        HABfluids typedSrc = (HABfluids) sample;
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            dst.writeDouble(typedSrc.ARSOutletPressure);

            for(int i1__ = 0; i1__< 4; ++i1__){

                dst.writeDouble(typedSrc.HABmolefracs[i1__]);
            }

            dst.writeDouble(typedSrc.WD2Habkgs);

            dst.writeDouble(typedSrc.Hab2WWkgs);
        }
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            HABfluids typedDst = (HABfluids) dst;
            typedDst.clear();      
            try{
                typedDst.id = src.readInt();
                typedDst.temperature = src.readDouble();
                typedDst.pressure = src.readDouble();
                typedDst.ARSOutletPressure = src.readDouble();
                for(int i1__ = 0; i1__< 4; ++i1__){

                    typedDst.HABmolefracs[i1__] = src.readDouble();
                }

                typedDst.WD2Habkgs = src.readDouble();
                typedDst.Hab2WWkgs = src.readDouble();
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            HABfluids typedDst = (HABfluids) sample;
    ...
    */
    ...
    int mask) {
        return new HABfluidsDataWriter(native_writer, listener, mask, this);
    }
    ...
    int mask) {
        ...
        return new HABfluidsDataReader(native_reader, listener, mask, this);   
    ...
    protected HABfluidsTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME,true, HABfluidsTypeCode.VALUE, HABfluids.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected HABfluidsTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport, HABfluidsTypeCode.VALUE, HABfluids.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
