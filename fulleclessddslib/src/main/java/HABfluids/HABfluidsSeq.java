...
/**
* A sequence of HABfluids instances.
*/
public final class HABfluidsSeq extends LoanableSequence implements Copyable {
    // -----------------------------------------------------------------------
    // Package Fields
    // -----------------------------------------------------------------------
    ...
    */
    ...
    public HABfluidsSeq() {
        super(HABfluids.class);
    }

    public HABfluidsSeq (int initialMaximum) {
        super(HABfluids.class, initialMaximum);
    }

    public HABfluidsSeq (Collection elements) {
        super(HABfluids.class, elements);
    }

    public  HABfluids get(int index) { 
        return (HABfluids) super.get(index); 
    }
