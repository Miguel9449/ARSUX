...
public class UPAonTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "UPAon";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final UPAonTypeSupport _singleton
    = new UPAonTypeSupport();
    ...
    */
    public static UPAonTypeSupport get_instance() {
        return _singleton;
    }

    public static UPAonTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return UPAonTypeCode.VALUE;
    }
    ...
    * <code>this</code> is not a <code>UPAon</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        UPAon typedDst = (UPAon) destination;
        UPAon typedSrc = (UPAon) source;
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            dst.writeDouble(typedSrc.UPAon);
        }
    ...
    */
    ...
    int mask) {
        return new UPAonDataWriter (native_writer, listener, mask, this);            
    }
    ...
    int mask) {
        ...
        return new UPAonDataReader(native_reader, listener, mask, this);   
    ...
    protected UPAonTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME,true,UPAonTypeCode.VALUE,UPAon.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected UPAonTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,UPAonTypeCode.VALUE,UPAon.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
