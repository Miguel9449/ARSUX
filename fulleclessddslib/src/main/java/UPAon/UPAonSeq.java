...
/**
* A sequence of UPAon instances.
*/
public final class UPAonSeq extends LoanableSequence implements Copyable {
    // -----------------------------------------------------------------------
    // Package Fields
    // -----------------------------------------------------------------------
    ...
    */
    ...
    public UPAonSeq (int initialMaximum) {
        super(UPAon.class, initialMaximum);
    }

    public UPAonSeq (Collection elements) {
        super(UPAon.class, elements);
    }

    public  UPAon get(int index) { 
        return (UPAon) super.get(index); 
    }
    ...
    */
    public Object copy_from(Object src) {
        ...
        // copy 'new' UPAon objects (beyond the original size of this object)
