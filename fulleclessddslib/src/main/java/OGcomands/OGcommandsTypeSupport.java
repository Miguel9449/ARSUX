...
public class OGcommandsTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "OGcommands";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final OGcommandsTypeSupport _singleton
    = new OGcommandsTypeSupport();
    ...
    */
    public static OGcommandsTypeSupport get_instance() {
        return _singleton;
    }

    public static OGcommandsTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return OGcommandsTypeCode.VALUE;
    }

    public Object create_data() {
        return OGcommands.create();
    }
    ...
    * <code>this</code> is not a <code>OGcommands</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        OGcommands typedDst = (OGcommands) destination;
        OGcommands typedSrc = (OGcommands) source;
        ...
        Object sample) 
    {
        ...
        OGcommands typedSrc = (OGcommands) sample;
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            dst.writeDouble(typedSrc.OGPM4051);

            dst.writeDouble(typedSrc.OGSM4052);

            dst.writeDouble(typedSrc.OGSV01312);

            dst.writeDouble(typedSrc.OGSV0122);

            dst.writeDouble(typedSrc.OGSV0581);

            dst.writeDouble(typedSrc.OGStackCurrent);

            dst.writeDouble(typedSrc.OGSV0322);

            dst.writeDouble(typedSrc.OGSV03212);

            dst.writeDouble(typedSrc.OGSV03213);

            dst.writeDouble(typedSrc.OGSV16421);

            dst.writeDouble(typedSrc.OGSV02211);

            dst.writeDouble(typedSrc.OGSV02212);

            dst.writeDouble(typedSrc.OGHTR8095);
        }
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            OGcommands typedDst = (OGcommands) dst;
            typedDst.clear();      
            try{
                typedDst.id = src.readInt();
                typedDst.state = src.readInt();
                typedDst.rank = src.readInt();
                typedDst.OGPM4051 = src.readDouble();
                typedDst.OGSM4052 = src.readDouble();
                typedDst.OGSV01312 = src.readDouble();
                typedDst.OGSV0122 = src.readDouble();
                typedDst.OGSV0581 = src.readDouble();
                typedDst.OGStackCurrent = src.readDouble();
                typedDst.OGSV0322 = src.readDouble();
                typedDst.OGSV03212 = src.readDouble();
                typedDst.OGSV03213 = src.readDouble();
                typedDst.OGSV16421 = src.readDouble();
                typedDst.OGSV02211 = src.readDouble();
                typedDst.OGSV02212 = src.readDouble();
                typedDst.OGHTR8095 = src.readDouble();
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            OGcommands typedDst = (OGcommands) sample;
    ...
    */
    ...
    int mask) {
        return new OGcommandsDataWriter(native_writer, listener, mask, this);
    }
    ...
    int mask) {
        ...
        return new OGcommandsDataReader(native_reader, listener, mask, this);
    ...
    protected OGcommandsTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME,true, OGcommandsTypeCode.VALUE, OGcommands.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected OGcommandsTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport, OGcommandsTypeCode.VALUE, OGcommands.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
