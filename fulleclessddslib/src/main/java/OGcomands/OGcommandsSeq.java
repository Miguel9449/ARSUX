...
/**
* A sequence of OGcommands instances.
*/
public final class OGcommandsSeq extends LoanableSequence implements Copyable {
    // -----------------------------------------------------------------------
    // Package Fields
    // -----------------------------------------------------------------------
    ...
    */
    ...
    public OGcommandsSeq() {
        super(OGcommands.class);
    }

    public OGcommandsSeq (int initialMaximum) {
        super(OGcommands.class, initialMaximum);
    }

    public OGcommandsSeq (Collection elements) {
        super(OGcommands.class, elements);
    }

    public OGcommands get(int index) {
        return (OGcommands) super.get(index);
    }
