...
public class UWMSuserTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "UWMSuser";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final UWMSuserTypeSupport _singleton
    = new UWMSuserTypeSupport();
    ...
    */
    public static UWMSuserTypeSupport get_instance() {
        return _singleton;
    }

    public static UWMSuserTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return UWMSuserTypeCode.VALUE;
    }

    public Object create_data() {
        return UWMSuser.create();
    }
    ...
    * <code>this</code> is not a <code>UWMSuser</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        UWMSuser typedDst = (UWMSuser) destination;
        UWMSuser typedSrc = (UWMSuser) source;
        ...
        Object sample) 
    {
        ...
        UWMSuser typedSrc = (UWMSuser) sample;
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            UWMSuser typedDst = (UWMSuser) dst;
            typedDst.clear();      
            try{
                typedDst.id = src.readInt();
                typedDst.Micturition = src.readDouble();
                typedDst.Slug = src.readDouble();
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            UWMSuser typedDst = (UWMSuser) sample;
    ...
    */
    ...
    int mask) {
        return new UWMSuserDataWriter (native_writer, listener, mask, this);            
    }
    ...
    int mask) {
        ...
        return new UWMSuserDataReader(native_reader, listener, mask, this);   
    ...
    protected UWMSuserTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME,true, UWMSuserTypeCode.VALUE, UWMSuser.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected UWMSuserTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport, UWMSuserTypeCode.VALUE, UWMSuser.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
