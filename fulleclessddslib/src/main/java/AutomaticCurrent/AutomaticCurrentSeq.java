...
/**
* A sequence of AutomaticCurrent instances.
*/
public final class AutomaticCurrentSeq extends LoanableSequence implements Copyable {
    // -----------------------------------------------------------------------
    // Package Fields
    // -----------------------------------------------------------------------
    ...
    */
    ...
    public AutomaticCurrentSeq() {
        super(AutomaticCurrent.class);
    }

    public AutomaticCurrentSeq (int initialMaximum) {
        super(AutomaticCurrent.class, initialMaximum);
    }

    public AutomaticCurrentSeq (Collection elements) {
        super(AutomaticCurrent.class, elements);
    }

    public  AutomaticCurrent get(int index) { 
        return (AutomaticCurrent) super.get(index); 
    }
