...
public class AutomaticCurrentTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "AutomaticCurrent";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final AutomaticCurrentTypeSupport _singleton
    = new AutomaticCurrentTypeSupport();
    ...
    */
    public static AutomaticCurrentTypeSupport get_instance() {
        return _singleton;
    }

    public static AutomaticCurrentTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return AutomaticCurrentTypeCode.VALUE;
    }

    public Object create_data() {
        return AutomaticCurrent.create();
    }
    ...
    * <code>this</code> is not a <code>AutomaticCurrent</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        AutomaticCurrent typedDst = (AutomaticCurrent) destination;
        AutomaticCurrent typedSrc = (AutomaticCurrent) source;
        ...
        Object sample) 
    {
        ...
        AutomaticCurrent typedSrc = (AutomaticCurrent) sample;
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            dst.writeDouble(typedSrc.current);
        }
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            AutomaticCurrent typedDst = (AutomaticCurrent) dst;
            typedDst.clear();      
            try{
                typedDst.id = src.readInt();
                typedDst.current = src.readDouble();
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            AutomaticCurrent typedDst = (AutomaticCurrent) sample;
    ...
    */
    ...
    Object instance,
    Object key) {
        AutomaticCurrent typedDst
        = (AutomaticCurrent) instance;
        AutomaticCurrent typedSrc
        = (AutomaticCurrent) key;
    ...
    */
    ...
    int mask) {
        return new AutomaticCurrentDataWriter(native_writer, listener, mask, this);
    }
    ...
    int mask) {
        ...
        return new AutomaticCurrentDataReader(native_reader, listener, mask, this);
    ...
    protected AutomaticCurrentTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME,true, AutomaticCurrentTypeCode.VALUE,AutomaticCurrent.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected AutomaticCurrentTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport, AutomaticCurrentTypeCode.VALUE,AutomaticCurrent.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
