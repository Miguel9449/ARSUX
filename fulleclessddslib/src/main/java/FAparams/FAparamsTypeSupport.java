...
public class FAparamsTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "FAparams";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final FAparamsTypeSupport _singleton
    = new FAparamsTypeSupport();
    ...
    */
    public static FAparamsTypeSupport get_instance() {
        return _singleton;
    }

    public static FAparamsTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return FAparamsTypeCode.VALUE;
    }

    public Object create_data() {
        return FAparams.create();
    }
    ...
    * <code>this</code> is not a <code>FAparams</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        FAparams typedDst = (FAparams) destination;
        FAparams typedSrc = (FAparams) source;
    ...
    public long get_serialized_sample_max_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += CdrPrimitiveType.DOUBLE.getMaxSizeSerialized(currentAlignment) ;
        currentAlignment +=CdrPrimitiveType.DOUBLE.getArrayMaxSizeSerialized(currentAlignment,  (15));
        currentAlignment +=CdrPrimitiveType.DOUBLE.getArrayMaxSizeSerialized(currentAlignment,  (15));
        currentAlignment += CdrPrimitiveType.DOUBLE.getMaxSizeSerialized(currentAlignment) ;
        if (include_encapsulation) {
        ...
        Object sample) 
    {
        ...
        FAparams typedSrc = (FAparams) sample;
        ...
        currentAlignment  +=  CdrPrimitiveType.DOUBLE.getArrayMaxSizeSerialized(epd.getAlignment(currentAlignment),  (15));
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            dst.writeDouble(typedSrc.CHXscalingfactor);

            dst.writeDouble(typedSrc.CHXcoolantpph);

            for(int i1__ = 0; i1__< 15; ++i1__){

                dst.writeDouble(typedSrc.HTCOtemperatureK[i1__]);
            }

            for(int i1__ = 0; i1__< 15; ++i1__){

                dst.writeDouble(typedSrc.HTCOefficiency[i1__]);
            }

            dst.writeDouble(typedSrc.HTCOheaterScalingFactor);
        }
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            FAparams typedDst = (FAparams) dst;
            typedDst.clear();      
            try{
                typedDst.id = src.readInt();
                typedDst.state = src.readInt();
                typedDst.rank = src.readInt();
                typedDst.CHXscalingfactor = src.readDouble();
                typedDst.CHXcoolantpph = src.readDouble();
                for(int i1__ = 0; i1__< 15; ++i1__){

                    typedDst.HTCOtemperatureK[i1__] = src.readDouble();
                }

                for(int i1__ = 0; i1__< 15; ++i1__){

                    typedDst.HTCOefficiency[i1__] = src.readDouble();
                }

                typedDst.HTCOheaterScalingFactor = src.readDouble();
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            FAparams typedDst = (FAparams) sample;
    ...
    */
    ...
    int mask) {
        return new FAparamsDataWriter (native_writer, listener, mask, this);            
    }
    ...
    int mask) {
        ...
        return new FAparamsDataReader(native_reader, listener, mask, this);   
    ...
    protected FAparamsTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME,true,FAparamsTypeCode.VALUE,FAparams.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected FAparamsTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,FAparamsTypeCode.VALUE,FAparams.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
