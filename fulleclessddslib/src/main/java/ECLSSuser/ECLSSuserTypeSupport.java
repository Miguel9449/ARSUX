...
public class ECLSSuserTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "ECLSSuser";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final ECLSSuserTypeSupport _singleton
    = new ECLSSuserTypeSupport();
    ...
    */
    public static ECLSSuserTypeSupport get_instance() {
        return _singleton;
    }

    public static ECLSSuserTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return ECLSSuserTypeCode.VALUE;
    }

    public Object create_data() {
        return ECLSSuser.create();
    }
    ...
    * <code>this</code> is not a <code>ECLSSuser</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        ECLSSuser typedDst = (ECLSSuser) destination;
        ECLSSuser typedSrc = (ECLSSuser) source;
        ...
        Object sample) 
    {
        ...
        ECLSSuser typedSrc = (ECLSSuser) sample;
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            dst.writeBoolean(typedSrc.RelearnCurrent);
        }
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            ECLSSuser typedDst = (ECLSSuser) sample;
    ...
    */
    ...
    int mask) {
        return new ECLSSuserDataWriter (native_writer, listener, mask, this);            
    }
    ...
    int mask) {
        ...
        return new ECLSSuserDataReader(native_reader, listener, mask, this);   
    ...
    protected ECLSSuserTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME,true,ECLSSuserTypeCode.VALUE, ECLSSuser.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected ECLSSuserTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,ECLSSuserTypeCode.VALUE, ECLSSuser.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
