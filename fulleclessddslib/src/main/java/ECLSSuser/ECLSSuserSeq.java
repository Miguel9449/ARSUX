...
/**
* A sequence of ECLSSuser instances.
*/
public final class ECLSSuserSeq extends LoanableSequence implements Copyable {
    // -----------------------------------------------------------------------
    // Package Fields
    // -----------------------------------------------------------------------
    ...
    */
    ...
    public ECLSSuserSeq() {
        super(ECLSSuser.class);
    }

    public ECLSSuserSeq (int initialMaximum) {
        super(ECLSSuser.class, initialMaximum);
    }

    public ECLSSuserSeq (Collection elements) {
        super(ECLSSuser.class, elements);
    }

    public ECLSSuser get(int index) {
        return (ECLSSuser) super.get(index); 
    }
