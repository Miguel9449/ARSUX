...
public class InstantMetRatesTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "InstantMetRates";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final InstantMetRatesTypeSupport _singleton
    = new InstantMetRatesTypeSupport();
    ...
    */
    public static InstantMetRatesTypeSupport get_instance() {
        return _singleton;
    }

    public static InstantMetRatesTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return InstantMetRatesTypeCode.VALUE;
    }

    public Object create_data() {
        return InstantMetRates.create();
    }
    ...
    * <code>this</code> is not a <code>InstantMetRates</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        InstantMetRates typedDst = (InstantMetRates) destination;
        InstantMetRates typedSrc = (InstantMetRates) source;
        ...
        Object sample) 
    {
        ...
        InstantMetRates typedSrc = (InstantMetRates) sample;
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            dst.writeDouble(typedSrc.water);

            dst.writeDouble(typedSrc.SensibleWatts);

            dst.writeDouble(typedSrc.oxygen);

            dst.writeDouble(typedSrc.CO2);

            dst.writeDouble(typedSrc.Micturition);

            dst.writeDouble(typedSrc.WaterUsekgs);

            dst.writeDouble(typedSrc.HabHeatWatts);
        }
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            InstantMetRates typedDst = (InstantMetRates) dst;
            typedDst.clear();      
            try{
                typedDst.id = src.readInt();
                typedDst.water = src.readDouble();
                typedDst.SensibleWatts = src.readDouble();
                typedDst.oxygen = src.readDouble();
                typedDst.CO2 = src.readDouble();
                typedDst.Micturition = src.readDouble();
                typedDst.WaterUsekgs = src.readDouble();
                typedDst.HabHeatWatts = src.readDouble();
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            InstantMetRates typedDst = (InstantMetRates) sample;
    ...
    */
    ...
    Object instance,
    Object key) {
        InstantMetRates typedDst
        = (InstantMetRates) instance;
        InstantMetRates typedSrc
        = (InstantMetRates) key;
    ...
    */
    ...
    int mask) {
        return new InstantMetRatesDataWriter(native_writer, listener, mask, this);
    }
    ...
    int mask) {
        ...
        return new InstantMetRatesDataReader(native_reader, listener, mask, this);   
    ...
    protected InstantMetRatesTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME,true,InstantMetRatesTypeCode.VALUE, InstantMetRates.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected InstantMetRatesTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,InstantMetRatesTypeCode.VALUE, InstantMetRates.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
