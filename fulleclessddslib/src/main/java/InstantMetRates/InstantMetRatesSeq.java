...
/**
* A sequence of InstantMetRates instances.
*/
public final class InstantMetRatesSeq extends LoanableSequence implements Copyable {
    // -----------------------------------------------------------------------
    // Package Fields
    // -----------------------------------------------------------------------
    ...
    */
    ...
    public InstantMetRatesSeq() {
        super(InstantMetRates.class);
    }

    public InstantMetRatesSeq (int initialMaximum) {
        super(InstantMetRates.class, initialMaximum);
    }

    public InstantMetRatesSeq (Collection elements) {
        super(InstantMetRates.class, elements);
    }

    public InstantMetRates get(int index) {
        return (InstantMetRates) super.get(index); 
    }
