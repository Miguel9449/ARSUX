...
public class OGsensorsTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "OGsensors";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final OGsensorsTypeSupport _singleton
    = new OGsensorsTypeSupport();
    ...
    */
    public static OGsensorsTypeSupport get_instance() {
        return _singleton;
    }

    public static OGsensorsTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return OGsensorsTypeCode.VALUE;
    }

    public Object create_data() {
        return OGsensors.create();
    }
    ...
    * <code>this</code> is not a <code>OGsensors</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        OGsensors typedDst = (OGsensors) destination;
        OGsensors typedSrc = (OGsensors) source;
        ...
        Object sample) 
    {
        ...
        OGsensors typedSrc = (OGsensors) sample;
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            dst.writeDouble(typedSrc.OGP73211);

            dst.writeDouble(typedSrc.OGP73212);

            dst.writeDouble(typedSrc.OGT75411);

            dst.writeDouble(typedSrc.OGT75412);

            dst.writeDouble(typedSrc.OGDP7131);

            dst.writeDouble(typedSrc.OGN80011);

            dst.writeDouble(typedSrc.OGF75311);

            dst.writeDouble(typedSrc.OGF75313);

            dst.writeDouble(typedSrc.OGP7111);

            dst.writeDouble(typedSrc.OGRSAquantity);

            dst.writeDouble(typedSrc.OGG82421);

            dst.writeDouble(typedSrc.OGCS71912);

            dst.writeDouble(typedSrc.OGN80012);

            dst.writeDouble(typedSrc.OGP7312);

            dst.writeDouble(typedSrc.OGP73113);

            dst.writeDouble(typedSrc.OGP71211);

            dst.writeDouble(typedSrc.OGP71212);

            dst.writeDouble(typedSrc.OGT72411);

            dst.writeDouble(typedSrc.OGT72412);
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            OGsensors typedDst = (OGsensors) dst;
            typedDst.clear();      
            try{
                typedDst.id = src.readInt();
                typedDst.state = src.readInt();
                typedDst.OGP73211 = src.readDouble();
                typedDst.OGP73212 = src.readDouble();
                typedDst.OGT75411 = src.readDouble();
                typedDst.OGT75412 = src.readDouble();
                typedDst.OGDP7131 = src.readDouble();
                typedDst.OGN80011 = src.readDouble();
                typedDst.OGF75311 = src.readDouble();
                typedDst.OGF75313 = src.readDouble();
                typedDst.OGP7111 = src.readDouble();
                typedDst.OGRSAquantity = src.readDouble();
                typedDst.OGG82421 = src.readDouble();
                typedDst.OGCS71912 = src.readDouble();
                typedDst.OGN80012 = src.readDouble();
                typedDst.OGP7312 = src.readDouble();
                typedDst.OGP73113 = src.readDouble();
                typedDst.OGP71211 = src.readDouble();
                typedDst.OGP71212 = src.readDouble();
                typedDst.OGT72411 = src.readDouble();
                typedDst.OGT72412 = src.readDouble();
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            OGsensors typedDst = (OGsensors) sample;
    ...
    */
    ...
    int mask) {
        return new OGsensorsDataWriter (native_writer, listener, mask, this);            
    }
    ...
    int mask) {
        ...
        return new OGsensorsDataReader(native_reader, listener, mask, this);   
    ...
    protected OGsensorsTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME,true,OGsensorsTypeCode.VALUE, OGsensors.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected OGsensorsTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,OGsensorsTypeCode.VALUE, OGsensors.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
