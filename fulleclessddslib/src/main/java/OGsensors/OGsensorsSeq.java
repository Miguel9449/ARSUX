...
/**
* A sequence of OGsensors instances.
*/
public final class OGsensorsSeq extends LoanableSequence implements Copyable {
    // -----------------------------------------------------------------------
    // Package Fields
    // -----------------------------------------------------------------------
    ...
    */
    ...
    public OGsensorsSeq() {
        super(OGsensors.class);
    }

    public OGsensorsSeq (int initialMaximum) {
        super(OGsensors.class, initialMaximum);
    }

    public OGsensorsSeq (Collection elements) {
        super(OGsensors.class, elements);
    }

    public OGsensors get(int index) {
        return (OGsensors) super.get(index); 
    }
