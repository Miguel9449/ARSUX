...
/**
* A sequence of UWMSfluids instances.
*/
public final class UWMSfluidsSeq extends LoanableSequence implements Copyable {
    // -----------------------------------------------------------------------
    // Package Fields
    // -----------------------------------------------------------------------
    ...
    */
    ...
    public UWMSfluidsSeq() {
        super(UWMSfluids.class);
    }

    public UWMSfluidsSeq (int initialMaximum) {
        super(UWMSfluids.class, initialMaximum);
    }

    public UWMSfluidsSeq (Collection elements) {
        super(UWMSfluids.class, elements);
    }

    public  UWMSfluids get(int index) { 
        return (UWMSfluids) super.get(index); 
    }
