...
public class UWMSfluidsTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "UWMSfluids";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final UWMSfluidsTypeSupport _singleton
    = new UWMSfluidsTypeSupport();
    ...
    */
    public static UWMSfluidsTypeSupport get_instance() {
        return _singleton;
    }

    public static UWMSfluidsTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return UWMSfluidsTypeCode.VALUE;
    }

    public Object create_data() {
        return UWMSfluids.create();
    }
    ...
    * <code>this</code> is not a <code>UWMSfluids</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        UWMSfluids typedDst = (UWMSfluids) destination;
        UWMSfluids typedSrc = (UWMSfluids) source;
        ...
        Object sample) 
    {
        ...
        UWMSfluids typedSrc = (UWMSfluids) sample;
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            dst.writeDouble(typedSrc.WD2UWMSkgs);

            dst.writeDouble(typedSrc.UWMS2UPAkgs);
        }
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            UWMSfluids typedDst = (UWMSfluids) dst;
            typedDst.clear();      
            try{
                typedDst.id = src.readInt();
                typedDst.WD2UWMSkgs = src.readDouble();
                typedDst.UWMS2UPAkgs = src.readDouble();
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            UWMSfluids typedDst = (UWMSfluids) sample;
    ...
    */
    ...
    int mask) {
        return new UWMSfluidsDataWriter (native_writer, listener, mask, this);            
    }
    ...
    int mask) {
        ...
        return new UWMSfluidsDataReader(native_reader, listener, mask, this);   
    ...
    protected UWMSfluidsTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME,true,UWMSfluidsTypeCode.VALUE,UWMSfluids.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected UWMSfluidsTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,UWMSfluidsTypeCode.VALUE,UWMSfluids.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
