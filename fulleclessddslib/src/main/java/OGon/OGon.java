...
public class OGon   implements Copyable, Serializable{

    public int id= 0;
    public int state= 0;
    public int rank= 0;
    public double OGon= 0;

    public OGon() {

    }
    public OGon (OGon other) {
    ...
    * This method could be placed into <code>OGonTypeSupport</code>
    ...
    */
    ...
    public String toString(String desc, int indent) {
        ...
        CdrHelper.printIndent(strBuffer, indent+1);        
        strBuffer.append("OGon: ").append(OGon).append("\n");  
