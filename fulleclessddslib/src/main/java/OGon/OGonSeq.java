...
/**
* A sequence of OGon instances.
*/
public final class OGonSeq extends LoanableSequence implements Copyable {
    // -----------------------------------------------------------------------
    // Package Fields
    // -----------------------------------------------------------------------
    ...
    */
    ...
    public OGonSeq (int initialMaximum) {
        super(OGon.class, initialMaximum);
    }

    public OGonSeq (Collection elements) {
        super(OGon.class, elements);
    }

    public  OGon get(int index) { 
        return (OGon) super.get(index); 
    }
    ...
    */
    public Object copy_from(Object src) {
        ...
        // copy 'new' OGon objects (beyond the original size of this object)
