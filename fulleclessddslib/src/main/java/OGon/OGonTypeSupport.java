...
public class OGonTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "OGon";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final OGonTypeSupport _singleton
    = new OGonTypeSupport();
    ...
    */
    public static OGonTypeSupport get_instance() {
        return _singleton;
    }

    public static OGonTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return OGonTypeCode.VALUE;
    }
    ...
    * <code>this</code> is not a <code>OGon</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        OGon typedDst = (OGon) destination;
        OGon typedSrc = (OGon) source;
    ...
    */
    ...
    int mask) {
        return new OGonDataWriter(native_writer, listener, mask, this);
    }
    ...
    int mask) {
        ...
        return new OGonDataReader(native_reader, listener, mask, this);   
    ...
    protected OGonTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME,true, OGonTypeCode.VALUE, OGon.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected OGonTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport, OGonTypeCode.VALUE, OGon.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
