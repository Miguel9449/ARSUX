...
public class UWMScommandsTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "UWMScommands";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final UWMScommandsTypeSupport _singleton
    = new UWMScommandsTypeSupport();
    ...
    */
    public static UWMScommandsTypeSupport get_instance() {
        return _singleton;
    }

    public static UWMScommandsTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return UWMScommandsTypeCode.VALUE;
    }

    public Object create_data() {
        return UWMScommands.create();
    }
    ...
    * <code>this</code> is not a <code>UWMScommands</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        UWMScommands typedDst = (UWMScommands) destination;
        UWMScommands typedSrc = (UWMScommands) source;
        ...
        Object sample) 
    {
        ...
        UWMScommands typedSrc = (UWMScommands) sample;
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            dst.writeDouble(typedSrc.SV01);

            dst.writeDouble(typedSrc.SV03);
        }
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            UWMScommands typedDst = (UWMScommands) dst;
            typedDst.clear();      
            try{
                typedDst.id = src.readInt();
                typedDst.state = src.readInt();
                typedDst.rank = src.readInt();
                typedDst.SV01 = src.readDouble();
                typedDst.SV03 = src.readDouble();
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            UWMScommands typedDst = (UWMScommands) sample;
    ...
    */
    ...
    Object instance,
    Object key) {
        UWMScommands typedDst
        = (UWMScommands) instance;
        UWMScommands typedSrc
        = (UWMScommands) key;
    ...
    */
    ...
    int mask) {
        return new UWMScommandsDataWriter (native_writer, listener, mask, this);            
    }
    ...
    int mask) {
        ...
        return new UWMScommandsDataReader(native_reader, listener, mask, this);   
    ...
    protected UWMScommandsTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME,true,UWMScommandsTypeCode.VALUE,UWMScommands.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected UWMScommandsTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,UWMScommandsTypeCode.VALUE,UWMScommands.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
