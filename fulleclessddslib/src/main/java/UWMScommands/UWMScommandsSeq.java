...
/**
* A sequence of UWMScommands instances.
*/
public final class UWMScommandsSeq extends LoanableSequence implements Copyable {
    // -----------------------------------------------------------------------
    // Package Fields
    // -----------------------------------------------------------------------
    ...
    */
    ...
    public UWMScommandsSeq() {
        super(UWMScommands.class);
    }

    public UWMScommandsSeq (int initialMaximum) {
        super(UWMScommands.class, initialMaximum);
    }

    public UWMScommandsSeq (Collection elements) {
        super(UWMScommands.class, elements);
    }

    public  UWMScommands get(int index) { 
        return (UWMScommands) super.get(index); 
    }
