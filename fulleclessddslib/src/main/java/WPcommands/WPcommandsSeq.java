...
/**
* A sequence of WPcommands instances.
*/
public final class WPcommandsSeq extends LoanableSequence implements Copyable {
    // -----------------------------------------------------------------------
    // Package Fields
    // -----------------------------------------------------------------------
    ...
    */
    ...
    public WPcommandsSeq() {
        super(WPcommands.class);
    }

    public WPcommandsSeq (int initialMaximum) {
        super(WPcommands.class, initialMaximum);
    }

    public WPcommandsSeq (Collection elements) {
        super(WPcommands.class, elements);
    }

    public WPcommands get(int index) {
        return (WPcommands) super.get(index); 
    }
