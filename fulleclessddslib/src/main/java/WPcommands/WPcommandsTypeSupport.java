...
public class WPcommandsTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "WPcommands";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final WPcommandsTypeSupport _singleton
    = new WPcommandsTypeSupport();
    ...
    */
    public static WPcommandsTypeSupport get_instance() {
        return _singleton;
    }

    public static WPcommandsTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return WPcommandsTypeCode.VALUE;
    }

    public Object create_data() {
        return WPcommands.create();
    }
    ...
    * <code>this</code> is not a <code>WPcommands</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        WPcommands typedDst = (WPcommands) destination;
        WPcommands typedSrc = (WPcommands) source;
        ...
        Object sample) 
    {
        ...
        WPcommands typedSrc = (WPcommands) sample;
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            dst.writeDouble(typedSrc.WPSV01211);

            dst.writeDouble(typedSrc.WPPM4111);

            dst.writeDouble(typedSrc.WPSM4121);

            dst.writeDouble(typedSrc.WPPP4117);

            dst.writeDouble(typedSrc.WPSV01212);

            dst.writeDouble(typedSrc.WPSV11211);

            dst.writeDouble(typedSrc.WPSV0133);

            dst.writeDouble(typedSrc.WPSV11212);

            dst.writeDouble(typedSrc.WPSV0122);

            dst.writeDouble(typedSrc.WPSV11213);

            dst.writeDouble(typedSrc.WPSV1101);

            dst.writeDouble(typedSrc.WPSV11261);
        }
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            WPcommands typedDst = (WPcommands) dst;
            typedDst.clear();      
            try{
                typedDst.id = src.readInt();
                typedDst.state = src.readInt();
                typedDst.rank = src.readInt();
                typedDst.WPSV01211 = src.readDouble();
                typedDst.WPPM4111 = src.readDouble();
                typedDst.WPSM4121 = src.readDouble();
                typedDst.WPPP4117 = src.readDouble();
                typedDst.WPSV01212 = src.readDouble();
                typedDst.WPSV11211 = src.readDouble();
                typedDst.WPSV0133 = src.readDouble();
                typedDst.WPSV11212 = src.readDouble();
                typedDst.WPSV0122 = src.readDouble();
                typedDst.WPSV11213 = src.readDouble();
                typedDst.WPSV1101 = src.readDouble();
                typedDst.WPSV11261 = src.readDouble();
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            WPcommands typedDst = (WPcommands) sample;
    ...
    */
    ...
    int mask) {
        return new WPcommandsDataWriter(native_writer, listener, mask, this);
    }
    ...
    int mask) {
        ...
        return new WPcommandsDataReader(native_reader, listener, mask, this);   
    ...
    protected WPcommandsTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME,true, WPcommandsTypeCode.VALUE, WPcommands.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected WPcommandsTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport, WPcommandsTypeCode.VALUE, WPcommands.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
