...
/**
* A sequence of FAcommands instances.
*/
public final class FAcommandsSeq extends LoanableSequence implements Copyable {
    // -----------------------------------------------------------------------
    // Package Fields
    // -----------------------------------------------------------------------
    ...
    */
    ...
    public FAcommandsSeq() {
        super(FAcommands.class);
    }

    public FAcommandsSeq (int initialMaximum) {
        super(FAcommands.class, initialMaximum);
    }

    public FAcommandsSeq (Collection elements) {
        super(FAcommands.class, elements);
    }

    public  FAcommands get(int index) { 
        return (FAcommands) super.get(index); 
    }
