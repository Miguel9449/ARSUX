...
public class FAuserTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "FAuser";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final FAuserTypeSupport _singleton
    = new FAuserTypeSupport();
    ...
    */
    public static FAuserTypeSupport get_instance() {
        return _singleton;
    }

    public static FAuserTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return FAuserTypeCode.VALUE;
    }

    public Object create_data() {
        return FAuser.create();
    }
    ...
    * <code>this</code> is not a <code>FAuser</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        FAuser typedDst = (FAuser) destination;
        FAuser typedSrc = (FAuser) source;
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            for(int i1__ = 0; i1__< 4; ++i1__){
                ...
                dst.writeDouble(typedSrc.HEXSetTimes[i1__]);
            }

            for(int i1__ = 0; i1__< 4; ++i1__){

                dst.writeDouble(typedSrc.HEXSetPoints[i1__]);
            }

            dst.writeDouble(typedSrc.Fn01rpm);

            dst.writeDouble(typedSrc.HEXcontrolgain);
        }
        ...
        if(deserialize_sample) {
            ...
            try{
                ...
                for(int i1__ = 0; i1__< 4; ++i1__){
                    ...
                    typedDst.HEXSetTimes[i1__] = src.readDouble();
                }

                for(int i1__ = 0; i1__< 4; ++i1__){

                    typedDst.HEXSetPoints[i1__] = src.readDouble();
                }

                typedDst.Fn01rpm = src.readDouble();
                typedDst.HEXcontrolgain = src.readDouble();
    ...
    */
    ...
    int mask) {
        return new FAuserDataWriter (native_writer, listener, mask, this);            
    }
    ...
    int mask) {
        ...
        return new FAuserDataReader(native_reader, listener, mask, this);   
    ...
    protected FAuserTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME,true,FAuserTypeCode.VALUE, FAuser.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected FAuserTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,FAuserTypeCode.VALUE, FAuser.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
