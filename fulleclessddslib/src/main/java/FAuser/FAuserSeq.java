...
/**
* A sequence of FAuser instances.
*/
public final class FAuserSeq extends LoanableSequence implements Copyable {
    // -----------------------------------------------------------------------
    // Package Fields
    // -----------------------------------------------------------------------
    ...
    */
    ...
    public FAuserSeq (int initialMaximum) {
        super(FAuser.class, initialMaximum);
    }

    public FAuserSeq (Collection elements) {
        super(FAuser.class, elements);
    }

    public FAuser get(int index) {
        return (FAuser) super.get(index); 
    }
    ...
    */
    public Object copy_from(Object src) {
        ...
        // copy 'new' FAuser objects (beyond the original size of this object)
