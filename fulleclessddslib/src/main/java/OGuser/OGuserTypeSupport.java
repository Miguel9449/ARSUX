...
public class OGuserTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "OGuser";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final OGuserTypeSupport _singleton
    = new OGuserTypeSupport();
    ...
    */
    public static OGuserTypeSupport get_instance() {
        return _singleton;
    }

    public static OGuserTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return OGuserTypeCode.VALUE;
    }

    public Object create_data() {
        return OGuser.create();
    }
    ...
    * <code>this</code> is not a <code>OGuser</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        OGuser typedDst = (OGuser) destination;
        OGuser typedSrc = (OGuser) source;
    ...
    */
    ...
    int mask) {
        return new OGuserDataWriter(native_writer, listener, mask, this);
    }
    ...
    int mask) {
        ...
        return new OGuserDataReader(native_reader, listener, mask, this);   
    ...
    protected OGuserTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME,true, OGuserTypeCode.VALUE, OGuser.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected OGuserTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport, OGuserTypeCode.VALUE, OGuser.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
