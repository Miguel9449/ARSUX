...
public class  OGuserTypeCode {
    ...
    private static TypeCode getTypeCode() {
        ...
        sm[__i]=new  StructMember("current", false, (short)-1,  false,(TypeCode) TypeCode.TC_DOUBLE,3 , false);__i++;

        tc = TypeCodeFactory.TheTypeCodeFactory.create_struct_tc("OGuser", ExtensibilityKind.EXTENSIBLE_EXTENSIBILITY,  sm);
        return tc;
    }
}
