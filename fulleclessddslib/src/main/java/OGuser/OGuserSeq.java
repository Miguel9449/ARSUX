...
/**
* A sequence of OGuser instances.
*/
public final class OGuserSeq extends LoanableSequence implements Copyable {
    // -----------------------------------------------------------------------
    // Package Fields
    // -----------------------------------------------------------------------
    ...
    */
    ...
    public OGuserSeq (int initialMaximum) {
        super(OGuser.class, initialMaximum);
    }

    public OGuserSeq (Collection elements) {
        super(OGuser.class, elements);
    }

    public OGuser get(int index) {
        return (OGuser) super.get(index); 
    }
    ...
    */
    public Object copy_from(Object src) {
        ...
        // copy 'new' OGuser objects (beyond the original size of this object)
