...
public class WPon   implements Copyable, Serializable{

    public int id= 0;
    public int state= 0;
    public int rank= 0;
    public double WPon= 0;

    public WPon() {

    }
    public WPon (WPon other) {
    ...
    * This method could be placed into <code>WPonTypeSupport</code>
    ...
    */
    ...
    public String toString(String desc, int indent) {
        ...
        CdrHelper.printIndent(strBuffer, indent+1);        
        strBuffer.append("WPon: ").append(WPon).append("\n");  
