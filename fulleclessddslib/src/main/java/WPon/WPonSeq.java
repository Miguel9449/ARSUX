...
/**
* A sequence of WPon instances.
*/
public final class WPonSeq extends LoanableSequence implements Copyable {
    // -----------------------------------------------------------------------
    // Package Fields
    // -----------------------------------------------------------------------
    ...
    */
    ...
    public WPonSeq (int initialMaximum) {
        super(WPon.class, initialMaximum);
    }

    public WPonSeq (Collection elements) {
        super(WPon.class, elements);
    }

    public  WPon get(int index) { 
        return (WPon) super.get(index); 
    }
    ...
    */
    public Object copy_from(Object src) {
        ...
        // copy 'new' WPon objects (beyond the original size of this object)
