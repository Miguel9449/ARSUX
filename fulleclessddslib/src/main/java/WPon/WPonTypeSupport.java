...
public class WPonTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "WPon";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final WPonTypeSupport _singleton
    = new WPonTypeSupport();
    ...
    */
    public static WPonTypeSupport get_instance() {
        return _singleton;
    }

    public static WPonTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return WPonTypeCode.VALUE;
    }
    ...
    * <code>this</code> is not a <code>WPon</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        WPon typedDst = (WPon) destination;
        WPon typedSrc = (WPon) source;
    ...
    */
    ...
    int mask) {
        return new WPonDataWriter(native_writer, listener, mask, this);
    }
    ...
    int mask) {
        ...
        return new WPonDataReader(native_reader, listener, mask, this);
    ...
    protected WPonTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME,true, WPonTypeCode.VALUE,WPon.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected WPonTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport, WPonTypeCode.VALUE,WPon.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
