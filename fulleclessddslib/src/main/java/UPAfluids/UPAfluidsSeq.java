...
/**
* A sequence of UPAfluids instances.
*/
public final class UPAfluidsSeq extends LoanableSequence implements Copyable {
    // -----------------------------------------------------------------------
    // Package Fields
    // -----------------------------------------------------------------------
    ...
    */
    ...
    public UPAfluidsSeq() {
        super(UPAfluids.class);
    }

    public UPAfluidsSeq (int initialMaximum) {
        super(UPAfluids.class, initialMaximum);
    }

    public UPAfluidsSeq (Collection elements) {
        super(UPAfluids.class, elements);
    }

    public UPAfluids get(int index) {
        return (UPAfluids) super.get(index); 
    }
