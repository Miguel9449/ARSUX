...
public class UPAfluidsTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "UPAfluids";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final UPAfluidsTypeSupport _singleton
    = new UPAfluidsTypeSupport();
    ...
    */
    public static UPAfluidsTypeSupport get_instance() {
        return _singleton;
    }

    public static UPAfluidsTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return UPAfluidsTypeCode.VALUE;
    }

    public Object create_data() {
        return UPAfluids.create();
    }
    ...
    * <code>this</code> is not a <code>UPAfluids</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        UPAfluids typedDst = (UPAfluids) destination;
        UPAfluids typedSrc = (UPAfluids) source;
        ...
        Object sample) 
    {
        ...
        UPAfluids typedSrc = (UPAfluids) sample;
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            dst.writeDouble(typedSrc.UPA2WWkelvins);

            dst.writeDouble(typedSrc.UPA2WWkgs);

            dst.writeDouble(typedSrc.BPAVaporkgs);

            dst.writeDouble(typedSrc.BPA2HabHeatW);
        }
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            UPAfluids typedDst = (UPAfluids) dst;
            typedDst.clear();      
            try{
                typedDst.id = src.readInt();
                typedDst.UPA2WWkelvins = src.readDouble();
                typedDst.UPA2WWkgs = src.readDouble();
                typedDst.BPAVaporkgs = src.readDouble();
                typedDst.BPA2HabHeatW = src.readDouble();
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            UPAfluids typedDst = (UPAfluids) sample;
    ...
    */
    ...
    int mask) {
        return new UPAfluidsDataWriter (native_writer, listener, mask, this);            
    }
    ...
    int mask) {
        ...
        return new UPAfluidsDataReader(native_reader, listener, mask, this);   
    ...
    protected UPAfluidsTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME,true,UPAfluidsTypeCode.VALUE, UPAfluids.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected UPAfluidsTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,UPAfluidsTypeCode.VALUE, UPAfluids.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
