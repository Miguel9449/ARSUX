...
/**
* A sequence of UWMSsensors instances.
*/
public final class UWMSsensorsSeq extends LoanableSequence implements Copyable {
    // -----------------------------------------------------------------------
    // Package Fields
    // -----------------------------------------------------------------------
    ...
    */
    ...
    public UWMSsensorsSeq() {
        super(UWMSsensors.class);
    }

    public UWMSsensorsSeq (int initialMaximum) {
        super(UWMSsensors.class, initialMaximum);
    }

    public UWMSsensorsSeq (Collection elements) {
        super(UWMSsensors.class, elements);
    }

    public  UWMSsensors get(int index) { 
        return (UWMSsensors) super.get(index); 
    }
