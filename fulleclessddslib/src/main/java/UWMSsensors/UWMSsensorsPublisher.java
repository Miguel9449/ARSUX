...
java -Djava.ext.dirs=$NDDSHOME/lib/java UWMSsensorsPublisher <domain_id>

java -Djava.ext.dirs=$NDDSHOME/lib/java UWMSsensorsSubscriber <domain_id>        
*/
...
public class UWMSsensorsPublisher {
    // -----------------------------------------------------------------------
    // Public Methods
    // -----------------------------------------------------------------------
    ...
    private static void publisherMain(int domainId, int sampleCount) {
        ...
        Topic topic = null;
        UWMSsensorsDataWriter writer = null;
        ...
        try {
            ...
            UWMSsensors instance = new UWMSsensors();
            ...
            ++count) {
                System.out.println("Writing UWMSsensors, count " + count);
