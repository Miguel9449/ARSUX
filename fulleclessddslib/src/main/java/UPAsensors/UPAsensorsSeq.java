...
/**
* A sequence of UPAsensors instances.
*/
public final class UPAsensorsSeq extends LoanableSequence implements Copyable {
    // -----------------------------------------------------------------------
    // Package Fields
    // -----------------------------------------------------------------------
    ...
    */
    ...
    public UPAsensorsSeq() {
        super(UPAsensors.class);
    }

    public UPAsensorsSeq (int initialMaximum) {
        super(UPAsensors.class, initialMaximum);
    }

    public UPAsensorsSeq (Collection elements) {
        super(UPAsensors.class, elements);
    }

    public UPAsensors get(int index) {
        return (UPAsensors) super.get(index); 
    }
