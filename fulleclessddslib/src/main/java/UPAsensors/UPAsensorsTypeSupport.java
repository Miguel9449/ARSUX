...
public class UPAsensorsTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "UPAsensors";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final UPAsensorsTypeSupport _singleton
    = new UPAsensorsTypeSupport();
    ...
    */
    public static UPAsensorsTypeSupport get_instance() {
        return _singleton;
    }

    public static UPAsensorsTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return UPAsensorsTypeCode.VALUE;
    }

    public Object create_data() {
        return UPAsensors.create();
    }
    ...
    * <code>this</code> is not a <code>UPAsensors</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        UPAsensors typedDst = (UPAsensors) destination;
        UPAsensors typedSrc = (UPAsensors) source;
        ...
        Object sample) 
    {
        ...
        UPAsensors typedSrc = (UPAsensors) sample;
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            dst.writeDouble(typedSrc.WSTAkg);

            dst.writeDouble(typedSrc.ARFTAkg);

            dst.writeDouble(typedSrc.BPAkg);

            dst.writeDouble(typedSrc.S2);

            dst.writeDouble(typedSrc.S5);

            dst.writeDouble(typedSrc.K1);
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            UPAsensors typedDst = (UPAsensors) dst;
            typedDst.clear();      
            try{
                typedDst.id = src.readInt();
                typedDst.state = src.readInt();
                typedDst.WSTAkg = src.readDouble();
                typedDst.ARFTAkg = src.readDouble();
                typedDst.BPAkg = src.readDouble();
                typedDst.S2 = src.readDouble();
                typedDst.S5 = src.readDouble();
                typedDst.K1 = src.readDouble();
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            UPAsensors typedDst = (UPAsensors) sample;
    ...
    */
    ...
    int mask) {
        return new UPAsensorsDataWriter (native_writer, listener, mask, this);            
    }
    ...
    int mask) {
        ...
        return new UPAsensorsDataReader(native_reader, listener, mask, this);   
    ...
    protected UPAsensorsTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME,true,UPAsensorsTypeCode.VALUE,UPAsensors.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected UPAsensorsTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,UPAsensorsTypeCode.VALUE,UPAsensors.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
