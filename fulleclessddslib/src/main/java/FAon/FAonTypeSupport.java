...
public class FAonTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "FAon";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final FAonTypeSupport _singleton
    = new FAonTypeSupport();
    ...
    */
    public static FAonTypeSupport get_instance() {
        return _singleton;
    }

    public static FAonTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return FAonTypeCode.VALUE;
    }
    ...
    * <code>this</code> is not a <code>FAon</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        FAon typedDst = (FAon) destination;
        FAon typedSrc = (FAon) source;
    ...
    */
    ...
    int mask) {
        return new FAonDataWriter(native_writer, listener, mask, this);
    }
    ...
    int mask) {
        ...
        return new FAonDataReader(native_reader, listener, mask, this);   
    ...
    protected FAonTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME,true, FAonTypeCode.VALUE, FAon.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected FAonTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport, FAonTypeCode.VALUE, FAon.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
