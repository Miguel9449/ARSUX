...
/**
* A sequence of FAon instances.
*/
public final class FAonSeq extends LoanableSequence implements Copyable {
    // -----------------------------------------------------------------------
    // Package Fields
    // -----------------------------------------------------------------------
    ...
    */
    ...
    public FAonSeq (int initialMaximum) {
        super(FAon.class, initialMaximum);
    }

    public FAonSeq (Collection elements) {
        super(FAon.class, elements);
    }

    public  FAon get(int index) { 
        return (FAon) super.get(index); 
    }
    ...
    */
    public Object copy_from(Object src) {
        ...
        // copy 'new' FAon objects (beyond the original size of this object)
